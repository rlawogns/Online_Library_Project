...
<body>
	...
	<div id="mid">
		<div id="menu">
			...
			<tr>
				<td>
				<button id="menubutton" type="submit" value= "1"  name="pagenum" id="searchbutton" >도서</button>
				</td>
			</tr>
			</form>
			...
			<tr>
				...
				<button id="menubutton" type="submit" value= "1"  name="pagenum" id="searchbutton" >도서대여</button>
				</td>
			</tr>
			</form>
...
$query = "select e.isbn, e.title, a.author,e.publisher,e.year from ebook e,authors a where e.isbn = a.isbn and e.title like '%$text%'";
